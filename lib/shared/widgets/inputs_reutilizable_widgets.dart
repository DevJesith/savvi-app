...
// Provider que expone el controller del email
final emailControllerProvider = Provider<TextEditingController>((ref) {
  return TextEditingController();
});

// Provider que expone el controller del password
final passwordControllerProvider = Provider<TextEditingController>((ref) {
  return TextEditingController();
});

// ==========================================
// 1. CREAS EL NOTIFIER PARA EL BOOLEANO
// ==========================================
class ObscureTextNotifier extends Notifier<bool> {
  @override
  bool build() {
    return true; // Estado inicial (oculto por defecto)
  }

  // Método para alternar entre visible y oculto
  void toggle() {
    state = !state;
  }
}
...
// ==========================================
// 2. CREAS EL NOTIFIER PROVIDER NUEVO
// ==========================================
